...
<head>
    ...
    <title>Register - Banjar CMS</title>
    ...
    <div class="w-full max-w-md">
        <div class="bg-white rounded-lg shadow-lg p-8">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <button type="submit" class="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-medium py-2 rounded-md">Daftar</button>
            </form>

            <p class="text-center text-gray-600 mt-4 text-sm">
                Sudah punya akun? <a href="{{ route('login') }}" class="text-indigo-600 hover:text-indigo-800">Login</a>
            </p>
        </div>
    </div>
</body>
